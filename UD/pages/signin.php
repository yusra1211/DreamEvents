  ...
  <body>
    <div class="parent-div">
        ...
        <div class="half-overlay-div">
            ...
            <form class="pt-4 pl-4 pr-4" method="POST" action="intro.php">
                ...
                <p class="sign-switch">Already Have an Account? <a class="sign-sd" href="signup.php" style="color:#AA68FF;">SignUp</a></p>
            </form>
        </div>
    </div>
