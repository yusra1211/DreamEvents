...
.total-amount{
  ...
  <form action="process_payment.php" method="POST" class="Payment-Content p-5">
  ...
  <!-- Hidden fields to pass data -->
                  ...
                  <input type="text" name="phone" class="payment-input">

                  <!-- Total Amount -->
                  <div class="d-flex justify-content-between mt-5 p-3 w-100">
                      <label class="ph w-75">Total Amount:</label>
                      <label class="total-amount w-25"><?php echo $price; ?></label>
                  </div>
      ...
      <input type="hidden" name="price" value="<?php echo $price; ?>">
                  ...
                  <br>
                  <input type="text" name="trs_id" class="payment-input">

                  <div class="Payment-button-container" >
                      <button type="submit" class="payment-confirm-btn" data-toggle="modal" data-target="#PaymentModal" >CONFIRM</button>
                  </div>
              </form>
  </div>
